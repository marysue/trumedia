...
const NavigationFooter = () => {
    return (
    <div style={{position: "fixed", bottom: "0px", fontSize:"1.5em", paddingLeft: "40px", paddingRight: "40px", display: "flex", justifyContent: "space-between", alignItems: "center", width: "95%", height: "60px", backgroundColor: "#295a8e", color: "white", fontWeight: "bold" }}>
        <div>Mary Lark</div>
